...
( 
    ...
    TST_MSG TINYINT,
    ACTIVE TINYINT,
	TRCKING_ID VARCHAR (255) , 
	SRC_TRCKING_ID VARCHAR (255)
    )
...
CREATE TABLE $(SCHEMANAME).MS_PURGE_LOG
(
   PURG_ID        BIGINT,
...
CREATE SEQUENCE $(SCHEMANAME).PURGE_JOB_SEQ START WITH 1 INCREMENT BY 1 MINVALUE 1 MAXVALUE 9999999999;
