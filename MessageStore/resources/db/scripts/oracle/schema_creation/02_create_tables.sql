...
(
	...
	ACTIVE         NUMBER(1) DEFAULT 1,
	TRCKING_ID     VARCHAR2(255),
	SRC_TRCKING_ID VARCHAR2(255)
);
...
CREATE TABLE &SCHEMAOWNER.MS_PURGE_LOG
(
   PURG_ID        NUMBER (10),
...
CREATE SEQUENCE &SCHEMAOWNER.PURGE_JOB_SEQ START WITH 1 INCREMENT BY 1 MINVALUE 1 MAXVALUE 9999999999; 
